...
parser.add_argument('--model', type=str, default='bigscience/bloom-7b1')
...
model = BloomForCausalLM.from_pretrained(NAME_MODEL, device_map='auto', torch_dtype=torch.float16)
