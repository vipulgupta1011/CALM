...
NAME_MODEL = args.model  # gpt2 small
TOKENIZER_MAX_SEQ_LEN = 2048

BATCH_SIZE = 8  # Could be much bigger depending on your model and your GPU. To be tuned for speed performance
...
BATCH_SIZE = 16  # Could be much bigger depending on your model and your GPU. To be tuned for speed performance
...
model = GPT2LMHeadModel.from_pretrained(NAME_MODEL).to(device)
