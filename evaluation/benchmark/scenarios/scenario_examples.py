...
def prompt_generation_qa(task_name) :
...
def prompt_generation_mcqa(task_name) :
    file_path = get_file_path(task_name)
...
def prompt_generation_sentiment(task_name) :
    file_path = get_file_path(task_name)
...
def prompt_generation_sentiment_toxic(task_name) :
    file_path = get_file_path(task_name)
...
def prompt_generation_nli(task_name) :
    file_path = get_file_path(task_name)
...
def prompt_generation_wnli(task_name) :
    file_path = get_file_path(task_name)
...
def PassageSentimentExample(
        ...
        Passage: Yet the act is still charming here.
        Sentiment: positive
        """
...
def PassageSentimentToxicExample(
        ...
        This is how the prompt will look like :
        Passage: You, sir, are my hero. Any chance you remember what page that's on?
