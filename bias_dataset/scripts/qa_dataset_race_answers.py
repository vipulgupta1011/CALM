...
for idx in qa_templates:
    ...
    for j in range(50):
        ...
        #sample['race'] = 'white'
        answer_idx = [i, idx, white_answer, "white", source_dataset]
    ...
    for j in range(50):
        ...
        #sample['source_dataset'] = source_dataset
        #sample['race'] = 'black'
        answer_idx = [i, idx, black_answer, "black", source_dataset]
        answers_save.append(answer_idx)
    ...
    for j in range(50):
        ...
        answer_idx = [i, idx, hispanic_answer, "hispanic", source_dataset]
        answers_save.append(answer_idx)
    ...
    for j in range(50):
        ...
        #sample['source_dataset'] = source_dataset
        #sample['race'] = 'asian'
        answer_idx = [i, idx, asian_answer, "asian", source_dataset]
        answers_save.append(answer_idx)

        #dataset.append(sample)
        i += 1

write_csv(answers_save, "/home/nlp/vkg5164/code/bias_dataset/evaluation/gt/gt_qa_race.csv")
