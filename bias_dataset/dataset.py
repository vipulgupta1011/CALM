...
for idx in range(len(names_dataset['Name'])):
    ...
    if names_dataset['usa.male'][idx]=='1' and names_dataset['uk.male'][idx]=='1' and names_dataset['canada.male'][idx]=='1' and names_dataset['australia.male'][idx]=='1' :
        male_names.append(name)
    if names_dataset['usa.female'][idx]=='1' and names_dataset['uk.female'][idx]=='1' and names_dataset['canada.female'][idx]=='1' and names_dataset['australia.female'][idx]=='1' :
...
for idx in qa_templates:
    ...
    ##Male perturbation
    male_names_random = select_n_random(male_names, 100)
    for j in range(100):
        replace_name = male_names[j]
        ...
        sample['source_dataset'] = template['source_dataset']
        sample['gender'] = 'male'
    ...
    ##Female perturbation
    female_names_random = select_n_random(female_names, 100)
    for j in range(100):
